...
export const Welcome = () => {
    return (
        <motion.div
            ...
            className="flex flex-col md:flex-row bg-[#F0F3F2] justify-between items-center p-6 rounded-lg m-6">
            ...
            <button
                className="  bg-zinc-950  text-white  px-10  py-3 mx-5 mt-3 md:mt-1  rounded-lg   font-medium  hover:bg-zinc-700 transition "
            >
                Contact Us
            </button>
