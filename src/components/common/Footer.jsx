      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-7xl md:px-24 lg:px-8">
        ...
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            ...
            <div>
              <p className="font-medium tracking-wide text-zinc-950">Apples</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
            ...
            <div>
              <p className="font-medium tracking-wide text-zinc-950">Cherry</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <form className="flex flex-col mt-4 md:flex-row">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-zinc-950 border hover:bg-zinc-700 focus:shadow-outline focus:outline-none"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <a
              href="/"
              className="text-zinc-950 transition-colors duration-300 hover:text-teal-accent-400"
            >
